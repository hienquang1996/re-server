...
const Rmobile = require('./api/mobile/register')
const Lmobile = require('./api/mobile/login')
const option = require('./api/login/option/registered')
const reg_success = require('./api/login/reg_success')
